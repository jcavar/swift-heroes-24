...
- [Pitch: Introduce `for borrow` and `for inout` to provide non-copying collection iteration](https://forums.swift.org/t/pitch-introduce-for-borrow-and-for-inout-to-provide-non-copying-collection-iteration/62549)
